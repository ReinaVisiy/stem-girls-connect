...
import { Mail, Facebook, Linkedin, Instagram, Youtube, MessageSquare, MapPin } from 'lucide-react';
      ...
      <section className="container mx-auto px-6 py-12">
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <ScrollReveal delay={100} className="bg-white p-12 rounded-[40px] shadow-xl border border-gray-100 flex flex-col items-center text-center hover:shadow-2xl transition-all">
            ...
            <p className="text-brandSlate mb-8 font-extrabold">{organization.contact.email}</p>
            <a 
          ...
          <ScrollReveal delay={200} className="bg-white p-12 rounded-[40px] shadow-xl border border-gray-100 flex flex-col items-center text-center hover:shadow-2xl transition-all">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-auto">
              ...
              <a href={organization.social.tiktok} target="_blank" rel="noopener noreferrer" className="px-4 py-4 bg-gray-50 rounded-2xl hover:bg-brandPink hover:text-white transition-all text-brandPink shadow-sm text-xs font-extrabold flex items-center">
                TikTok
              </a>
            </div>
          </ScrollReveal>
